...
def render():
    ...
    if st.session_state.get('analise_amplitude_executada', False):
        ...
        # --- SEÇÃO 7: VXEWZ (Centralizada na página Volatilidade IV) ---
        st.subheader("Volatilidade Implícita Brasil (VXEWZ)")
        st.info("📊 A análise completa de Volatilidade Implícita foi **centralizada** na página **Volatilidade IV**. Acesse pelo menu lateral para ver: IV Rank, Bandas de Bollinger, Regime de Volatilidade, Taxa de Variação e muito mais.")
